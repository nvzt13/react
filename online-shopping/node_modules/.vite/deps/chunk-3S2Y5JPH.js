...
function deepClone(source) {
  if (React10.isValidElement(source) || !isPlainObject(source)) {
    return source;
  }
  const output = {};
...
function deepmerge(target, source, options = {
  ...
  if (isPlainObject(target) && isPlainObject(source)) {
    Object.keys(source).forEach((key) => {
      if (React10.isValidElement(source[key])) {
...
function useMediaQueryOld(query, defaultMatches, matchMedia, ssrMatchMedia, noSsr) {
  const [match2, setMatch] = React16.useState(() => {
    if (noSsr && matchMedia) {
...
var ThemeContext2 = React27.createContext(null);
if (true) {
...
function useTheme4() {
  const theme = React28.useContext(ThemeContext_default);
  if (true) {
...
var PropsContext = React30.createContext(void 0);
...
function useDefaultProps({
  ...
  const ctx = React30.useContext(PropsContext);
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-3S2Y5JPH.js.map
